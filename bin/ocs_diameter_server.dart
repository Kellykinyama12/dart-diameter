...
void handleRequest(Socket socket) {
  socket.listen((data) {
    ...
    print('Received CCR with Session-Id: ${utf8.decode(request.avps.firstWhere((avp) => avp.code == 263).value)}');
    ...
    final responseAvps = [
      ...
      AVP(
        code: 420, // CC-Session-Failover AVP code
        mandatory: true,
        protected: false,
        value: Uint8List.fromList([0]), // No failover
      ),
    ];
